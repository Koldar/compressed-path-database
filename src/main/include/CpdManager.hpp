#ifndef _COMPRESSED_PATH_DATABASE_CPD_MANAGER_HEADER__
#define _COMPRESSED_PATH_DATABASE_CPD_MANAGER_HEADER__
...
namespace compressed_path_database {
    ...
    public:
         ...
         */
        CpdManager(const boost::filesystem::path& cpdPath, const cpp_utils::graphs::IImmutableGraph<G, V, cost_t>& g): cpdPath{cpdPath}, context{nullptr} {
            this->saveCpd(g);
            this->loadCpd(g);
        }
        /**
         ...
         */
        const cpp_utils::graphs::IImmutableGraph<G, V, cost_t>& getReorderedGraph() const {
         ...
         */
        const cpp_utils::graphs::IImmutableGraph<G, V, cost_t>& loadCpd(const cpp_utils::graphs::IImmutableGraph<G, V, cost_t>& g) {
        ...
        cpp_utils::vectorplus<cpp_utils::graphs::nodeid_t> generateOptimalPathOfNodes(cpp_utils::graphs::nodeid_t current, cpp_utils::graphs::nodeid_t target) const {
            cpp_utils::vectorplus<cpp_utils::graphs::nodeid_t> result{};
         ...
         */
        cpp_utils::vectorplus<cpp_utils::graphs::moveid_t> generateOptimalPathOfMoves(cpp_utils::graphs::nodeid_t current, cpp_utils::graphs::nodeid_t target) const {
            cpp_utils::vectorplus<cpp_utils::graphs::moveid_t> result{};
            this->generateOptimalPath(current, target, nullptr, &result, nullptr);
            return result;
        }
        cost_t generateOptimalPathCost(cpp_utils::graphs::nodeid_t current, cpp_utils::graphs::nodeid_t target) const {
            cost_t result;
            this->generateOptimalPath(current, target, nullptr, nullptr, &result);
            return result;
        }
        void generateOptimalPath(cpp_utils::graphs::nodeid_t current, cpp_utils::graphs::nodeid_t target, std::vector<cpp_utils::graphs::nodeid_t>* nodes, std::vector<cpp_utils::graphs::moveid_t>* moves, cost_t* cost) const {
            if (this->context == nullptr) {
                throw cpp_utils::exceptions::InvalidStateException<CpdManager>{*this};
            }
